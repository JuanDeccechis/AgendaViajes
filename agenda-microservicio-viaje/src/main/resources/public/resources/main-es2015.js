...
let TokenStorageService = class TokenStorageService {
    ...
    getToken() {
        let data = JSON.parse(sessionStorage.getItem("auth-user"));
        if (data) {
...
/* harmony import */ var _viaje_create_create_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./viaje/create/create.component */ "./src/app/viaje/create/create.component.ts");
/* harmony import */ var _viaje_view_view_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./viaje/view/view.component */ "./src/app/viaje/view/view.component.ts");
/* harmony import */ var _viaje_plan_createplan_createplan_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./viaje/plan/createplan/createplan.component */ "./src/app/viaje/plan/createplan/createplan.component.ts");
...
const routes = [
    ...
    { path: 'viaje/create', component: _viaje_create_create_component__WEBPACK_IMPORTED_MODULE_10__["CreateComponent"] },
    { path: 'viaje/:viajeId/ver', component: _viaje_view_view_component__WEBPACK_IMPORTED_MODULE_11__["ViewComponent"] },
    { path: 'plan/:viajeId/create', component: _viaje_plan_createplan_createplan_component__WEBPACK_IMPORTED_MODULE_12__["CreateplanComponent"] },
...
/* harmony import */ var _viaje_create_create_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./viaje/create/create.component */ "./src/app/viaje/create/create.component.ts");
/* harmony import */ var _viaje_view_view_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./viaje/view/view.component */ "./src/app/viaje/view/view.component.ts");
/* harmony import */ var _filtro_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./filtro.pipe */ "./src/app/filtro.pipe.ts");
/* harmony import */ var _viaje_plan_createplan_createplan_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./viaje/plan/createplan/createplan.component */ "./src/app/viaje/plan/createplan/createplan.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _viaje_create_create_component__WEBPACK_IMPORTED_MODULE_15__["CreateComponent"],
            _viaje_view_view_component__WEBPACK_IMPORTED_MODULE_16__["ViewComponent"],
            _filtro_pipe__WEBPACK_IMPORTED_MODULE_17__["FiltroPipe"],
            _viaje_plan_createplan_createplan_component__WEBPACK_IMPORTED_MODULE_18__["CreateplanComponent"]
        ],
        imports: [
...
let BoardAdminComponent = class BoardAdminComponent {
    ...
    reporteUsuarios(event) {
        this.userService.getReporteUsuarios().subscribe(data => {
            console.log(data);
            this.content = data;
        }, err => {
    ...
    reporteZonas(event) {
        this.userService.getReporteZonas().subscribe(data => {
            console.log(data);
            this.content = data;
        }, err => {
            this.content = JSON.parse(err.error).message;
...
let BoardUserComponent = class BoardUserComponent {
    ...
    constructor(userService) {
        ...
        this.viajes = '';
        this.regiones = [];
        this.viaje_tables = [{ "nombre": "Titulo", }, { "nombre": "Destino", }, { "nombre": "Origen", }, { "nombre": "Fecha Inicio", }, { "nombre": "Fecha Fin", }, { "nombre": "Descripcion", }];
        this.region = 'Elegir..';
        this.estado = 'null';
    }
    ngOnInit() {
        ...
        //   }
        //   );
        this.userService.getZonasGeograficas().subscribe(data => {
            this.regiones = data;
            this.regiones.push({
                "nombre": "Elegir.."
            });
    ...
    generarReporte() {
        ...
        if (this.region != "Elegir..") {
            this.userService.getViajesZonasGeograficas(this.region).subscribe(data => {
                this.viajes = data;
            }, err => {
                this.regiones = JSON.parse(err.error).message;
            });
        ...
        if (this.hasta && this.desde) {
            ...
            this.userService.getViajesRangoFechas(this.desde, this.hasta).subscribe(data => {
                console.log(data);
                this.viajes = data;
            }, err => {
                this.regiones = JSON.parse(err.error).message;
...
let FiltroPipe = class FiltroPipe {
    transform(value, desde, hasta, estado, region) {
        if (!desde || !hasta) {
            return value;
        }
        else {
            ...
            return value.filter(plan => new Date(plan["Fecha Inicio"]) >= startDate && new Date(plan["Fecha Fin"]) <= endDate);
        }
    }
};
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        this.userService.getViajes().subscribe(data => {
            this.content = data;
            this.vie(data);
        }, err => {
            this.content = JSON.parse(err.error).message;
...
let CreateComponent = class CreateComponent {
    ...
    onSubmit() {
        this.userService.saveViaje(this.form, this.tokenStorageService.getUser()).subscribe(data => {
            if (data) {
                window.location.reload();
            }
        }, err => {
...
CreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-create',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./create.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/viaje/create/create.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./create.component.css */ "./src/app/viaje/create/create.component.css")).default]
    })
], CreateComponent);
...
let CreateplanComponent = class CreateplanComponent {
    ...
    onSubmit() {
        if (this.tipoForm == "transporte") {
            this.userService.savePlanTransporte(this.formTransporte, this.id).subscribe(data => {
                if (data) {
                    window.location.reload();
                }
            }, err => {
            ...
            this.userService.savePlanAlojamiento(this.formAlojamiento, this.id).subscribe(data => {
                if (data) {
                    window.location.reload();
                }
            }, err => {
...
CreateplanComponent.ctorParameters = () => [
    { type: _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
CreateplanComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-createplan',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./createplan.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/viaje/plan/createplan/createplan.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./createplan.component.css */ "./src/app/viaje/plan/createplan/createplan.component.css")).default]
    })
], CreateplanComponent);
...
let ViewComponent = class ViewComponent {
    constructor(userService, route, router) {
        ...
        this.router = router;
        this.viaje_tables = [{ "nombre": "Titulo", }, { "nombre": "Destino", }, { "nombre": "Origen", }, { "nombre": "Fecha Inicio", }, { "nombre": "Fecha Fin", }, { "nombre": "Descripcion", }];
        this.transporte_tables = [{ "nombre": "Nombre", }, { "nombre": "Transporte", }, { "nombre": "Fecha Inicio", }, { "nombre": "Fecha Fin", }, { "nombre": "Ciudad Origen", }, { "nombre": "Ciudad Destino", }, { "nombre": "Terminal Salida", }, { "nombre": "Terminal Llegada", }, { "nombre": "Nro Asiento", }, { "nombre": "Nro Viaje", }, { "nombre": "Codigo Reserva", }];
        this.alojamiento_tables = [{ "nombre": "", }, { "nombre": "Destino", }, { "nombre": "Origen", }, { "nombre": "Fecha Inicio", }, { "nombre": "Fecha Fin", }, { "nombre": "Descripcion", }];
    }
    ngOnInit() {
        this.id = this.route.snapshot.params['viajeId'];
        console.log(this.id);
        this.userService.getViaje(this.id).subscribe(data => {
            this.viaje = data;
...
ViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-view',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./view.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/viaje/view/view.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./view.component.css */ "./src/app/viaje/view/view.component.css")).default]
    })
], ViewComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Mateo\Documents\workspace-spring-tool-suite-4-4.8.0.RELEASE\AgendaViajes\front-angular\src\main.ts */"./src/main.ts");
